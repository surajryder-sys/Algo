"""Configuration for the V6S Scraper -- V6-Sentinel's own TradingView OB-zone
scraper (renamed/ported 2026-09-21 from v5_sentinel/tv_scraper, itself ported
from v3/tv_scraper; V5S prefixes became V6S) --
...
runs as a fully self-contained V6-Sentinel process.
...
def load_config() -> Config:
    return Config(
        ...
        chart_url=os.getenv("V6S_TV_SCRAPER_CHART_URL", "https://www.tradingview.com/chart/mL7E68j4/"),
        symbol=os.getenv("V6S_TV_SCRAPER_SYMBOL", "XAUUSD"),
        timeframe=os.getenv("V6S_TV_SCRAPER_TIMEFRAME", "5"),
        ...
        # scraper is running.
        profile_dir=os.getenv("V6S_TV_SCRAPER_PROFILE_DIR",
                               r"C:\Users\ARK\AppData\Local\BraveSoftware\Brave-Browser\User Data"),
        poll_seconds=float(os.getenv("V6S_TV_SCRAPER_POLL_SECONDS", "5")),
        zone_state_file=os.getenv("V6S_TV_SCRAPER_ZONE_STATE_FILE", "v6s_tv_scraper_zones.json"),
        first_seen_state_file=os.getenv("V6S_TV_SCRAPER_FIRST_SEEN_FILE", "v6s_tv_scraper_first_seen.json"),
        retest_state_file=os.getenv("V6S_TV_SCRAPER_RETEST_FILE", "v6s_tv_scraper_retest.json"),
        live_snapshot_file=os.getenv("V6S_TV_SCRAPER_LIVE_SNAPSHOT_FILE", "v6s_tv_scraper_live.json"),
        mitigation_track_file=os.getenv("V6S_TV_SCRAPER_MITIGATION_TRACK_FILE", "v6s_tv_scraper_mitigation_track.json"),
        zone_history_log_file=os.getenv("V6S_TV_SCRAPER_ZONE_HISTORY_LOG_FILE", "v6s_tv_scraper_zone_history.jsonl"),
        browser_executable_path=os.getenv("V6S_TV_SCRAPER_BROWSER_PATH") or None,
        ...
        # panes.
        grid_rows=int(os.getenv("V6S_TV_SCRAPER_GRID_ROWS", "2")),
        grid_cols=int(os.getenv("V6S_TV_SCRAPER_GRID_COLS", "4")),
        ...
        window_x=int(os.getenv("V6S_TV_SCRAPER_WINDOW_X", "822")),
        window_y=int(os.getenv("V6S_TV_SCRAPER_WINDOW_Y", "-1440")),
        window_width=int(os.getenv("V6S_TV_SCRAPER_WINDOW_WIDTH", "3440")),
        window_height=int(os.getenv("V6S_TV_SCRAPER_WINDOW_HEIGHT", "1440")),
        cdp_port=int(os.getenv("V6S_TV_SCRAPER_CDP_PORT", "9223")),
    )
