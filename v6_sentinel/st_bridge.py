"""Supertrend bridge reader. Ported verbatim from v5_sentinel/st_bridge.py
(2026-09-18) -- already fully symbol-parametrized and stateless.

Reads SUPERTREND_{symbol}_{tf}.json, published by
mql5/ATR_Trial_Dual_SuperTrend_Major_Minor_HammerStar.mq5's
PublishSTBridgeFile() (EnableSupertrend switch, ST_-prefixed inputs),
same OBBridge Common Files folder as the ATR Dual bridge, a SEPARATE file
from ATRSTATE_DUAL_....
...
from v6_sentinel.bridge import MAX_AGE_SECONDS, _bar_time_stale, _bridge_root
...
def fresh_flip(symbol: str, tf_minutes: int) -> Optional[SupertrendState]:
    ...
    closed bar (event_time == bar_time) -- same "privileged, momentary"
