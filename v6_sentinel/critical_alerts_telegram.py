"""Minimal Telegram Bot API client -- sendMessage plus getUpdates. Ported
verbatim from v5_sentinel/critical_alerts_telegram.py (2026-09-18) --
fully generic, no symbol/state coupling at all.
"""
