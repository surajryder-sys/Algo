...
Multi-instrument note (2026-09-18, V6S): BridgeBarFlipTracker's
...
instance with its OWN state file (V6S's symbol-agnostic-instance
...
from v6_sentinel import bridge
from v6_sentinel.flip_state import Confirmed, EventType, FlipEvent, FlipStateResult, far_near_line
from v6_sentinel.rates import _TIMEFRAME_CONST
