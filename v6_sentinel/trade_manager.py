...
Ported verbatim from v5_sentinel/trade_manager.py (2026-09-18) -- keyed
...
component's own main loop, which has the relevant bias signals
available -- this module only ever manages the CURRENT open position's
own profit-booking progress.
"""
...
class TradeManager:
    ...
    def is_partially_cut(self, ticket: int) -> bool:
        ...
        fired for this ticket -- used by the caller's own same-direction
