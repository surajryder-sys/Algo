...
# where "python -m algo.main" happens to be launched from -- two processes
# started from different working directories would each create their own
# lock file in a different location and never conflict, which is exactly
# how a duplicate slipped through despite this lock being in place
