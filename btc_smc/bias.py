"""SMC bias state machine for the BTCUSD bot: combines M5/M15/M30 order-block
...
Same structure as the ETHUSD bot: no bias-only non-trading timeframe --
...
def allowed_entry_sources(bias: BiasResult) -> frozenset:
    ...
    direction. No always-on fallback timeframe -- every source here is gated
    purely by the bias state."""
