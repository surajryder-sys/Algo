...
Independent copy for the ETHUSD bot (see eth_smc/config.py) -- connects to
its own separate MT5 terminal install, never the XAUUSD terminal.
"""
...
from eth_smc.config import Config
