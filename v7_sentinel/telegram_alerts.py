...
per-lineage isolation convention (see CLAUDE.md) means v7_sentinel never
imports from v3 directly -- this is V7-Sentinel's own copy, trimmed to just
what zone_touch_alert.py needs (no getUpdates/long-poll listener here, V7S
...
def send_if_configured(bot_token: str | None, chat_id: str | None, text: str) -> None:
    ...
    try:
        ...
        print(f"[V7S-ALERT] send failed: {exc!r}")
