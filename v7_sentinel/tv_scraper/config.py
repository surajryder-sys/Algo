"""Configuration for the V7S Scraper -- V7-Sentinel's own TradingView OB-zone
scraper (renamed/ported 2026-09-21 from v5_sentinel/tv_scraper, itself ported
from v3/tv_scraper; V5S prefixes became V7S) --
...
runs as a fully self-contained V7-Sentinel process.
...
def load_config() -> Config:
    return Config(
        ...
        chart_url=os.getenv("V7S_TV_SCRAPER_CHART_URL", "https://www.tradingview.com/chart/mL7E68j4/"),
        symbol=os.getenv("V7S_TV_SCRAPER_SYMBOL", "XAUUSD"),
        timeframe=os.getenv("V7S_TV_SCRAPER_TIMEFRAME", "5"),
        ...
        # scraper is running.
        profile_dir=os.getenv("V7S_TV_SCRAPER_PROFILE_DIR",
                               r"C:\Users\ARK\AppData\Local\BraveSoftware\Brave-Browser\User Data"),
        poll_seconds=float(os.getenv("V7S_TV_SCRAPER_POLL_SECONDS", "5")),
        zone_state_file=os.getenv("V7S_TV_SCRAPER_ZONE_STATE_FILE", "v7s_tv_scraper_zones.json"),
        first_seen_state_file=os.getenv("V7S_TV_SCRAPER_FIRST_SEEN_FILE", "v7s_tv_scraper_first_seen.json"),
        retest_state_file=os.getenv("V7S_TV_SCRAPER_RETEST_FILE", "v7s_tv_scraper_retest.json"),
        live_snapshot_file=os.getenv("V7S_TV_SCRAPER_LIVE_SNAPSHOT_FILE", "v7s_tv_scraper_live.json"),
        mitigation_track_file=os.getenv("V7S_TV_SCRAPER_MITIGATION_TRACK_FILE", "v7s_tv_scraper_mitigation_track.json"),
        zone_history_log_file=os.getenv("V7S_TV_SCRAPER_ZONE_HISTORY_LOG_FILE", "v7s_tv_scraper_zone_history.jsonl"),
        # Added 2026-09-24 (V7S Data Manager consolidation) -- this scraper wrote NO heartbeat at
        # all before; V6S's own Watchdog docstring even notes it was "left for later." Same
        # "written unconditionally every cycle" convention every other heartbeat in this project uses.
        heartbeat_file=os.getenv("V7S_TV_SCRAPER_HEARTBEAT_FILE", "v7s_tv_scraper_heartbeat.json"),
        browser_executable_path=os.getenv("V7S_TV_SCRAPER_BROWSER_PATH") or None,
        ...
        # panes.
        grid_rows=int(os.getenv("V7S_TV_SCRAPER_GRID_ROWS", "2")),
        grid_cols=int(os.getenv("V7S_TV_SCRAPER_GRID_COLS", "4")),
        ...
        window_x=int(os.getenv("V7S_TV_SCRAPER_WINDOW_X", "822")),
        window_y=int(os.getenv("V7S_TV_SCRAPER_WINDOW_Y", "-1440")),
        window_width=int(os.getenv("V7S_TV_SCRAPER_WINDOW_WIDTH", "3440")),
        window_height=int(os.getenv("V7S_TV_SCRAPER_WINDOW_HEIGHT", "1440")),
        cdp_port=int(os.getenv("V7S_TV_SCRAPER_CDP_PORT", "9223")),
    )
