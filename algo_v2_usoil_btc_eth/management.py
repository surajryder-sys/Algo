...
only: once a position is open, M15's own structure (the zone anchor) is
what should govern where the stop trails to. This is narrower than the
initial SL set at entry (candidates.py's _tier_edges, which still picks
whichever of M5/M15 is nearest for that one-time placement).
