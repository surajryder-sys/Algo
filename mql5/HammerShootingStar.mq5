...
//| already uses. Without this, a Hammer found on M5 kept showing up  |
//| after switching to M15/H1/etc (confirmed live, 2026-09-10) -- the |
//| label isn't wrong, it's just not restricted to the timeframe it   |
